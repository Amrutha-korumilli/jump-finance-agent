...
export async function addHubspotNote({ user,contactEmail, note  }) {
  console.log("🔖 Adding HubSpot note:", { contactEmail, note });
  ...
  console.log("✅ Note created successfully:", noteRes.data);
  return noteRes.data;
}
